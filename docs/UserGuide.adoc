...
Alias: `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [t/TAG]...`
...
* *Add* `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [t/TAG]...` (alias: `a`) +
e.g. `add n/James Ho p/22224444 e/jamesho@example.com a/123, Clementi Rd, 1234665 t/friend t/colleague`
* *Clear* : `clear` (alias: `c`) +
* *Delete* : `delete INDEX` (alias: `d`) +
e.g. `delete 3`
* *Edit* : `edit INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [t/TAG]...` (Alias: `e`) +
e.g. `edit 2 n/James Lee e/jameslee@example.com`
* *Find* : `find KEYWORD [MORE_KEYWORDS]` (alias: `f`) + 
e.g. `find James Jake`
* *List* : `list` (alias: `l`)
* *Help* : `help` (alias: `he`)
* *Select* : `select INDEX` (alias: `s`) +
e.g.`select 2`
* *History* : `history` (alias: `hi`)
* *Undo* : `undo` (alias: `u`)
* *Redo* : `redo` (alias: `r`)
